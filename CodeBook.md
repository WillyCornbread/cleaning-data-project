...
ActivityName                               |  name of the activity subject performed (LAYING,SITTING,STANDING,WALKING,WALKING_DOWNSTAIRS,WALKING_UPSTAIRS)
...
1. Split data into subjects, features we want mean() / std() and activities as well as test and train - merged to a single dataframe 

2. Pulled in activity description names

4. Data was reshaped with activity, feature as variables.

5. Added mean by group of subjecst, activity, and feature

6. New column names created for the tidy data

7. The data is  written to `tidy_means.txt` file
